    ...
    with open(path, 'r', encoding = 'utf8') as f:
        ...
        for index, single_line in enumerate(lines):
            ...
            if index == line_NN:
                ...
                result_string = "其中{}公噸({}%)殘存於海水表面，{}公噸({}%)因海水擾動混入海水中，{}公噸({}%)殘存於岸際，{}公噸({}%)揮發至大氣中".format(Surface,Surface_P, WaterColumn, WaterColumn_P, Ashore, Ashore_P, Evaporated, Evaporated_P)
